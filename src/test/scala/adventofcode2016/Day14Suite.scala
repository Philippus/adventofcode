...
//    assertEquals(determineIndexOf64thKey("abc"), 22728)
  //    assertEquals(determineIndexOf64thKey("yjdafjpo"), 25427)

  test("determines index of 64th key part two"):
//    assertEquals(determineIndexOf64thKeyPartTwo("abc"), 22551)
    assertEquals(determineIndexOf64thKeyPartTwo("yjdafjpo"), 25427)
end Day14Suite

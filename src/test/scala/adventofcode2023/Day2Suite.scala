...
class Day2Suite extends ScalaCheckSuite {
  property("finds possible game for a line") {
    assertEquals(possibleGame("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green", red = 12, green = 13, blue = 14), 1)
    assertEquals(possibleGame("Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue", 12, 13, 14), 2)
    assertEquals(possibleGame("Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red", 12, 13, 14), 0)
    assertEquals(possibleGame("Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red", 12, 13, 14), 0)
  ...
  property("finds possible game for a line") {
    assertEquals(powerGame("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green", red = 12, green = 13, blue = 14), 48)
    assertEquals(powerGame("Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue", 12, 13, 14), 12)
    assertEquals(powerGame("Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red", 12, 13, 14), 1560)
